                        ...
                        <table class="twelve columns">
                          <tr>
                            <td class="six sub-columns">
                              <h2>Ystäväkylän sähköpostikortti</h2>
                            </td>
                            <td class="six sub-columns last" style="text-align:right; vertical-align:middle;">
                              <span class="template-label"><a target="_blank" href="<?php echo $websiteurl; ?>">Katso netissä</a></span>
                            </td>
                  ...
                  <tr>
                    <td class="wrapper last">
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td>
                            <h1>Hei <?php echo $receiver_name; ?>!</h1>
                            <p>
                              <?php echo $uploader_name; ?> lähetti sinulle
                              Ystäväkylän sähköpostikorttipalvelun kautta tämän viestin:
                            </p>

                            <a target="_blank" href="<?php echo $websiteurl; ?>"><img src="<?php echo $imageurl; ?>" alt="<?php echo $message_title; ?>" width="100%"></a><br>
                            <h1><?php echo $message_title; ?></h1>
                            <p class="lead"><?php echo $message_content; ?></p>
                          </td>
                          <td class="expander"></td>
                        </tr>
                      </table>
                      ...
                      <td class="wrapper last">
                        ...
                        <table class="twelve columns">
                          <tr>
                            <td>
                              <p>
                                Löydät viestin myös täältä:
                                <a target="_blank" href="<?php echo $websiteurl; ?>"><?php echo $websiteurl; ?></a>
                              </p>
                            </td>
                            <td class="expander"></td>
                          </tr>
